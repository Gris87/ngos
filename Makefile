...
src/os/boot/build/boot.elf: src

src/os/configure/build/configure.elf: src

src/os/kernel/build/kernel.elf: src

tools/qt/image_builder/build/image_builder: tools
