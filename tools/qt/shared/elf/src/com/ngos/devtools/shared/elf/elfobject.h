#ifndef QT_SHARED_ELF_SRC_COM_NGOS_DEVTOOLS_SHARED_ELF_ELFOBJECT_H
#define QT_SHARED_ELF_SRC_COM_NGOS_DEVTOOLS_SHARED_ELF_ELFOBJECT_H
...
#endif // QT_SHARED_ELF_SRC_COM_NGOS_DEVTOOLS_SHARED_ELF_ELFOBJECT_H
