#ifndef COM_NGOS_DEVTOOLS_IMAGE_BUILDER_PE_COFFHEADER_H
#define COM_NGOS_DEVTOOLS_IMAGE_BUILDER_PE_COFFHEADER_H
...
#endif // COM_NGOS_DEVTOOLS_IMAGE_BUILDER_PE_COFFHEADER_H
