...
public:                                                                                                                                                                                                  // Colorize: green
    ...
    BaseCodeVerifier(quint64 verification); // TEST: NO                                                                                                                                                   // Colorize: green
                                                                                                                                                                                                         // Colorize: green
    static void verifyAll(CodeWorkerThread *worker, CodeFileInfo *fileInfo, const QString &content, const QStringList &lines); // TEST: NO                                                               // Colorize: green
                                                                                                                                                                                                         // Colorize: green
    static quint64 getAmountOfChecks(); // TEST: NO                                                                                                                                                       // Colorize: green
                                                                                                                                                                                                         // Colorize: green
...
private:                                                                                                                                                                                                 // Colorize: green
    ...
    static quint64                   sAmountOfChecks;                                                                                                                                                    // Colorize: green
                                                                                                                                                                                                         // Colorize: green
    quint64 mVerification;                                                                                                                                                                                // Colorize: green
};                                                                                                                                                                                                       // Colorize: green
                                                                                                                                                                                                         // Colorize: green
                                                                                                                                                                                                         // Colorize: green
                                                                                                                                                                                                         // Colorize: green
