#ifndef CODE_VERIFIER_SRC_VERIFIERS_ZZZ_TYPES_PRO_QTPROVERIFIER_H
#define CODE_VERIFIER_SRC_VERIFIERS_ZZZ_TYPES_PRO_QTPROVERIFIER_H
...
#endif // CODE_VERIFIER_SRC_VERIFIERS_ZZZ_TYPES_PRO_QTPROVERIFIER_H
