#ifndef QMAKE_SRC_COM_NGOS_DEVTOOLS_QMAKE_MAIN_QMAKE_H
#define QMAKE_SRC_COM_NGOS_DEVTOOLS_QMAKE_MAIN_QMAKE_H
...
#endif // QMAKE_SRC_COM_NGOS_DEVTOOLS_QMAKE_MAIN_QMAKE_H
