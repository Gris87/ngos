...
#define OPTION_X86_64_VECTORIZATION_MODE_AVX_512 9  // Compile kernel with AVX-512 vectorization
 ...
 ***/
#define NGOS_BUILD_KERNEL_ALIGN 0x0000000001000000
 ...
 ***         OPTION_X86_64_VECTORIZATION_MODE_AVX_512
 ***
 *** Default: OPTION_X86_64_VECTORIZATION_MODE_AVX2
 ***/
#define NGOS_BUILD_X86_64_VECTORIZATION_MODE OPTION_X86_64_VECTORIZATION_MODE_NONE
 ...
 ***/
#define NGOS_BUILD_X86_64_FUSED_MULTIPLY_ADD OPTION_X86_64_FUSED_MULTIPLY_ADD_NONE
...
#if NGOS_BUILD_KERNEL_ALIGN < 0x200000 || NGOS_BUILD_KERNEL_ALIGN > 0x01000000
#error Invalid value for NGOS_BUILD_KERNEL_ALIGN parameter
#endif

#if NGOS_BUILD_X86_64_VECTORIZATION_MODE < OPTION_X86_64_VECTORIZATION_MODE_NONE || NGOS_BUILD_X86_64_VECTORIZATION_MODE > OPTION_X86_64_VECTORIZATION_MODE_AVX_512
