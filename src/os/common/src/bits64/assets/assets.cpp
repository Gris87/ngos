...
extern void *_assets_begin; // _assets_begin is declared in linker.ld file // Ignore CppEqualAlignmentVerifier
extern void *_assets_end;   // _assets_end is declared in linker.ld file   // Ignore CppEqualAlignmentVerifier
