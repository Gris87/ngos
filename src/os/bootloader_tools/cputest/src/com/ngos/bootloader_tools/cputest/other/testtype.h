#ifndef COM_NGOS_BOOTLOADER_TOOLS_CPUTEST_OTHER_TESTTYPE_H
#define COM_NGOS_BOOTLOADER_TOOLS_CPUTEST_OTHER_TESTTYPE_H
...
#endif // COM_NGOS_BOOTLOADER_TOOLS_CPUTEST_OTHER_TESTTYPE_H
