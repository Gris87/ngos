...
#include "test/com/ngos/bootloader_tools/hddtest/sections/section1/testcase.h"
...
{ // Ignore CppNgosTraceVerifier
    ...
    UEFI_LI(("NGOS Bootloader Tool - HDD Test starting up"));
    ...
    UEFI_ASSERT_EXECUTION(HddTest::init(), UefiStatus::ABORTED);
    UEFI_LI(("HDD Test initialized"));



    UEFI_ASSERT_EXECUTION(HddTestGUI::init(&params), UefiStatus::ABORTED);
    UEFI_LI(("HDD Test GUI initialized"));



    UEFI_ASSERT_EXECUTION(HddTestGUI::exec(), UefiStatus::ABORTED); // Loop forever
