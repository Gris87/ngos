#ifndef PARTITIONWIZARD_SRC_BITS64_MAIN_PARTITIONWIZARDGUI_H
#define PARTITIONWIZARD_SRC_BITS64_MAIN_PARTITIONWIZARDGUI_H
...
#endif // PARTITIONWIZARD_SRC_BITS64_MAIN_PARTITIONWIZARDGUI_H
