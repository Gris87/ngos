#ifndef INSTALLER_SRC_COM_NGOS_INSTALLER_MAIN_INSTALLERGUI_H
#define INSTALLER_SRC_COM_NGOS_INSTALLER_MAIN_INSTALLERGUI_H
...
#endif // INSTALLER_SRC_COM_NGOS_INSTALLER_MAIN_INSTALLERGUI_H
