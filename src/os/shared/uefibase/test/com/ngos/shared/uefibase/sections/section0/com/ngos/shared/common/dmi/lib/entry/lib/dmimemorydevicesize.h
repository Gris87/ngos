...
TEST_CASES(section0, com_ngos_shared_common_dmi_lib_entry_lib_dmimemorydevicesize);
{
    TEST_CASE("size()");
    {
        ...
        temp.value       = 1;
        temp.granularity = DmiMemoryDeviceSizeGranularity::_1_MEGABYTE;
        ...
        temp.value       = 1;
        temp.granularity = DmiMemoryDeviceSizeGranularity::_1_KILOBYTE;
