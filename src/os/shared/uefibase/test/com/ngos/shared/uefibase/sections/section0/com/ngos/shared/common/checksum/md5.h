#ifndef COM_NGOS_SHARED_UEFIBASE_SECTIONS_SECTION0_COM_NGOS_SHARED_COMMON_CHECKSUM_MD5_H
#define COM_NGOS_SHARED_UEFIBASE_SECTIONS_SECTION0_COM_NGOS_SHARED_COMMON_CHECKSUM_MD5_H
...
TEST_CASES(section0, com_ngos_shared_common_checksum_md5);
{
    TEST_CASE("MD5()");
    {
        MD5 temp;
    ...
    TEST_CASE("md5()");
    {
        ...
        TEST_ASSERT_EQUALS(MD5::md5((bad_uint8 *)str, strlen(str)),   Md5Hash(0x961261C453991A8B, 0xD70478C4F8AB27A8));
...
#endif // COM_NGOS_SHARED_UEFIBASE_SECTIONS_SECTION0_COM_NGOS_SHARED_COMMON_CHECKSUM_MD5_H
