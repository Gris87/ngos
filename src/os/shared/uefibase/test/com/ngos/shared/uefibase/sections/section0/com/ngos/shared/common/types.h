...
TEST_CASES(section0, com_ngos_shared_common_types);
{
    TEST_CASE("Size of structures");
    {
        ...
        TEST_ASSERT_EQUALS(sizeof(ArrayList<bad_uint8>),                                                     24);
        ...
        TEST_ASSERT_EQUALS(sizeof(ListElement<bad_uint8>),                                                   24);
        TEST_ASSERT_EQUALS(sizeof(List<bad_uint8>),                                                          16);
        TEST_ASSERT_EQUALS(sizeof(MapElement<bad_uint8, bad_uint32>),                                               8);
        TEST_ASSERT_EQUALS(sizeof(Map<bad_uint8, bad_uint32>),                                                      24);
