#ifndef COM_NGOS_SHARED_UEFIBASE_SECTIONS_SECTION0_COM_NGOS_SHARED_COMMON_FPU_SSE41_SSE41_H
#define COM_NGOS_SHARED_UEFIBASE_SECTIONS_SECTION0_COM_NGOS_SHARED_COMMON_FPU_SSE41_SSE41_H
...
TEST_CASES(section0, com_ngos_shared_common_fpu_sse41_sse41);
{
    TEST_CASE("pmulld");
    {
        ...
        {
            bad_int32 a[4] = { 1981965841, -1987077212, 2003838066, -2103715301 };
            bad_int32 b[4] = { 1987132191, 1271329132, -1321971178, -1219321901 };
            bad_int32 c[4];
    ...
    TEST_CASE("pminsb");
    {
        if (CPU::hasFlag(X86Feature::XMM4_1))
        {
            bad_int8 a[16] = { 10, 64, 32, -46, -34, 97, -13, 64, 31, 97, -43, 37, 67, -24, 95, 32 };
            bad_int8 b[16] = { 31, 13, 92, -16, -54, 27, -73, 34, 41, 87, -63, 27, 47, -94, 35, 62 };
            bad_int8 c[16];
    ...
    TEST_CASE("pminsd");
    {
        if (CPU::hasFlag(X86Feature::XMM4_1))
        {
            bad_int32 a[4] = { 10, 64, 32, -46 };
            bad_int32 b[4] = { 31, 13, 92, -16 };
            bad_int32 c[4];
    ...
    TEST_CASE("pminud");
    {
        if (CPU::hasFlag(X86Feature::XMM4_1))
        {
            bad_uint32 a[4] = { 10, 64, 32, 46 };
            bad_uint32 b[4] = { 31, 13, 92, 16 };
            bad_uint32 c[4];
    ...
    TEST_CASE("pminuw");
    {
        if (CPU::hasFlag(X86Feature::XMM4_1))
        {
            bad_uint16 a[8] = { 10, 64, 32, 46, 34, 32, 97, 21 };
            bad_uint16 b[8] = { 31, 13, 92, 16, 35, 97, 32, 26 };
            bad_uint16 c[8];
...
#endif // COM_NGOS_SHARED_UEFIBASE_SECTIONS_SECTION0_COM_NGOS_SHARED_COMMON_FPU_SSE41_SSE41_H
