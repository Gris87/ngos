#ifndef COM_NGOS_SHARED_UEFIBASE_SECTIONS_SECTION0_COM_NGOS_SHARED_COMMON_FPU_AVX512CD_AVX512CD_H
#define COM_NGOS_SHARED_UEFIBASE_SECTIONS_SECTION0_COM_NGOS_SHARED_COMMON_FPU_AVX512CD_AVX512CD_H



#include <buildconfig.h>
#include <com/ngos/shared/common/cpu/cpu.h>
#include <com/ngos/shared/uefibase/sections/section0/com/ngos/shared/common/fpu/avx512cd/asm_testavx512cdvpbroadcastmb2q.h>
#include <com/ngos/shared/uefibase/sections/section0/com/ngos/shared/common/fpu/avx512cd/asm_testavx512cdvpbroadcastmw2d.h>
#include <com/ngos/shared/uefibase/sections/section0/com/ngos/shared/common/fpu/avx512cd/asm_testavx512cdvplzcntd.h>
#include <com/ngos/shared/uefibase/sections/section0/com/ngos/shared/common/fpu/avx512cd/asm_testavx512cdvplzcntq.h>
...
TEST_CASES(section0, com_ngos_shared_common_fpu_avx512cd_avx512cd);
{
    TEST_CASE("vpbroadcastmb2q");
    {
        if (CPU::hasFlag(X86Feature::AVX512CD))
        {
            bad_uint64 a[8] __attribute__((aligned(64)));
    ...
    TEST_CASE("vpbroadcastmw2d");
    {
        if (CPU::hasFlag(X86Feature::AVX512CD))
        {
            bad_uint32 a[16] __attribute__((aligned(64)));
    ...
    TEST_CASE("vplzcntd");
    {
        if (CPU::hasFlag(X86Feature::AVX512CD))
        {
            ...
            bad_uint32 b[16] __attribute__((aligned(64)));
    ...
    TEST_CASE("vplzcntq");
    {
        if (CPU::hasFlag(X86Feature::AVX512CD))
        {
            bad_uint64 a[8] __attribute__((aligned(64))) = { 910, 154, 434, 397, 231, 151, 533, 697 };
...
#endif // COM_NGOS_SHARED_UEFIBASE_SECTIONS_SECTION0_COM_NGOS_SHARED_COMMON_FPU_AVX512CD_AVX512CD_H
