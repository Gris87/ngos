#ifndef OS_SHARED_UEFIBASE_TEST_BITS64_SECTIONS_SECTION0___INCLUDE_ASM_INSTRUCTIONS_H
#define OS_SHARED_UEFIBASE_TEST_BITS64_SECTIONS_SECTION0___INCLUDE_ASM_INSTRUCTIONS_H
...
TEST_CASES(section0, __include_asm_instructions);
{
    TEST_CASE("rdrand()");
    {
...
#endif // OS_SHARED_UEFIBASE_TEST_BITS64_SECTIONS_SECTION0___INCLUDE_ASM_INSTRUCTIONS_H
