#ifndef OS_SHARED_UEFIBASE_TEST_BITS64_SECTIONS_SECTION0___INCLUDE_PAGETABLE_UTILS_H
#define OS_SHARED_UEFIBASE_TEST_BITS64_SECTIONS_SECTION0___INCLUDE_PAGETABLE_UTILS_H
...
TEST_CASES(section0, __include_pagetable_utils);
{
    TEST_CASE("pgdIndex()");
    {
...
#endif // OS_SHARED_UEFIBASE_TEST_BITS64_SECTIONS_SECTION0___INCLUDE_PAGETABLE_UTILS_H
