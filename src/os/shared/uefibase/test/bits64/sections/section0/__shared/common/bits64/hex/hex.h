#ifndef OS_SHARED_UEFIBASE_TEST_BITS64_SECTIONS_SECTION0___SHARED_COMMON_BITS64_HEX_HEX_H
#define OS_SHARED_UEFIBASE_TEST_BITS64_SECTIONS_SECTION0___SHARED_COMMON_BITS64_HEX_HEX_H
...
TEST_CASES(section0, __shared_common_bits64_hex_hex);
{
    TEST_CASE("toString()");
    {
        u8 bytes1[10];
...
#endif // OS_SHARED_UEFIBASE_TEST_BITS64_SECTIONS_SECTION0___SHARED_COMMON_BITS64_HEX_HEX_H
