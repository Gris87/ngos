...
TEST_CASES(section0, __shared_common_bits64_types);
{
    TEST_CASE("Size of structures");
    {
        ...
        TEST_ASSERT_EQUALS(sizeof(Button),                                        192);
        ...
        TEST_ASSERT_EQUALS(sizeof(CursorWidget),                                  104);
        ...
        TEST_ASSERT_EQUALS(sizeof(LabelWidget),                                   104);
        ...
        TEST_ASSERT_EQUALS(sizeof(RootWidget),                                    104000);
