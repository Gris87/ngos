...
inline const char8* enumToString(PciDevice149D device149D) // TEST: NO
{
    // COMMON_LT((" | device149D = %u", device149D)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice149D device149D) // TEST: NO
{
    // COMMON_LT((" | device149D = %u", device149D)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device149D, enumToString(device149D));
...
inline const char8* enumToHumanString(PciDevice149D device149D) // TEST: NO
{
    // COMMON_LT((" | device149D = %u", device149D)); // Commented to avoid bad looking logs
