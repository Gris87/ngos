...
enum class PciDevice10DF: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0720 = 0x0720,
    DEVICE_0722 = 0x0722,
...
inline const char8* enumToHumanString(PciDevice10DF device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
