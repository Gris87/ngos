...
#ifndef COM_NGOS_SHARED_COMMON_PCI_DATABASE_GENERATED_VENDOR8086_PCISUBDEVICE80868C22_H
#define COM_NGOS_SHARED_COMMON_PCI_DATABASE_GENERATED_VENDOR8086_PCISUBDEVICE80868C22_H
...
enum class PciSubDevice80868C22: u32 // Ignore CppEnumVerifier
{
    NONE               = 0,
...
inline const char8* enumToString(PciSubDevice80868C22 subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        case PciSubDevice80868C22::NONE:               return "NONE";
        case PciSubDevice80868C22::SUBDEVICE_102805D7: return "SUBDEVICE_102805D7";
...
inline const char8* enumToFullString(PciSubDevice80868C22 subDevice) // TEST: NO
{
    // COMMON_LT((" | subDevice = %u", subDevice)); // Commented to avoid bad looking logs
...
inline const char8* enumToHumanString(PciSubDevice80868C22 subDevice) // TEST: NO
{
    // COMMON_LT((" | subDevice = %u", subDevice)); // Commented to avoid bad looking logs
    ...
    switch (subDevice)
    {
        case PciSubDevice80868C22::SUBDEVICE_102805D7: return "Alienware X51 R2";
...
#endif // COM_NGOS_SHARED_COMMON_PCI_DATABASE_GENERATED_VENDOR8086_PCISUBDEVICE80868C22_H
