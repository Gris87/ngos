...
enum class PciDevice1014: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0002 = 0x0002,
    DEVICE_0005 = 0x0005,
...
inline const char8* enumToHumanString(PciDevice1014 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
