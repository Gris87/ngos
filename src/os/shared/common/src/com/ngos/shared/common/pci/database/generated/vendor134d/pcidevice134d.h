...
enum class PciDevice134D: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_2189 = 0x2189,
    DEVICE_2486 = 0x2486,
...
inline const char8* enumToHumanString(PciDevice134D device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
