...
enum class PciDevice11BD: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_002E = 0x002E,
    DEVICE_0040 = 0x0040,
...
inline const char8* enumToHumanString(PciDevice11BD device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
