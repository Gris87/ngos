...
enum class PciDevice1B21: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0611 = 0x0611,
    DEVICE_0612 = 0x0612,
...
inline const char8* enumToHumanString(PciDevice1B21 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
    ...
    switch (device)
    {
        ...
        case PciDevice1B21::DEVICE_2142: return "Unknown device";
