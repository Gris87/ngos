...
enum class PciSubDevice102215E1: bad_uint32 // Ignore CppEnumVerifier
{
    NONE               = 0,
...
inline const char8* enumToString(PciSubDevice102215E1 subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice102215E1::SUBDEVICE_1043876B: return "SUBDEVICE_1043876B";
        case PciSubDevice102215E1::SUBDEVICE_17AA5124: return "SUBDEVICE_17AA5124";
        case PciSubDevice102215E1::SUBDEVICE_EA50CE19: return "SUBDEVICE_EA50CE19";
...
inline const char8* enumToHumanString(PciSubDevice102215E1 subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice102215E1::SUBDEVICE_1043876B: return "PRIME Motherboard";
        case PciSubDevice102215E1::SUBDEVICE_17AA5124: return "ThinkPad E595";
        case PciSubDevice102215E1::SUBDEVICE_EA50CE19: return "mCOM10-L1900";
