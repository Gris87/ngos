...
enum class PciSubClass07: bad_uint8 // Ignore CppEnumVerifier
{
    SUB_CLASS_00 = 0x00,
    SUB_CLASS_01 = 0x01,
    SUB_CLASS_02 = 0x02,
...
inline const char8* enumToString(PciSubClass07 subClass) // TEST: NO
{
...
inline const char8* enumToFullString(PciSubClass07 subClass) // TEST: NO
{
    // COMMON_LT((" | subClass = %u", subClass)); // Commented to avoid bad looking logs
...
inline const char8* enumToHumanString(PciSubClass07 subClass, bad_uint8 interfaceId) // TEST: NO
{
