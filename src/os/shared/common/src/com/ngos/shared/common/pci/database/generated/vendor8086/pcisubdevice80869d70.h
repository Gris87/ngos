...
enum class PciSubDevice80869D70: u32 // Ignore CppEnumVerifier
{
    NONE               = 0,
...
inline const char8* enumToString(PciSubDevice80869D70 subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice80869D70::SUBDEVICE_17AA2247: return "SUBDEVICE_17AA2247";
...
inline const char8* enumToHumanString(PciSubDevice80869D70 subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice80869D70::SUBDEVICE_17AA2247: return "ThinkPad T570";
