...
inline const char8* enumToString(PciDevice1BEE device1BEE) // TEST: NO
{
    // COMMON_LT((" | device1BEE = %u", device1BEE)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1BEE device1BEE) // TEST: NO
{
    // COMMON_LT((" | device1BEE = %u", device1BEE)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1BEE, enumToString(device1BEE));
...
inline const char8* enumToHumanString(PciDevice1BEE device1BEE) // TEST: NO
{
    // COMMON_LT((" | device1BEE = %u", device1BEE)); // Commented to avoid bad looking logs
