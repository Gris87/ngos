...
inline const char8* enumToString(PciDevice11A9 device11A9) // TEST: NO
{
    // COMMON_LT((" | device11A9 = %u", device11A9)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice11A9 device11A9) // TEST: NO
{
    // COMMON_LT((" | device11A9 = %u", device11A9)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device11A9, enumToString(device11A9));
...
inline const char8* enumToHumanString(PciDevice11A9 device11A9) // TEST: NO
{
    // COMMON_LT((" | device11A9 = %u", device11A9)); // Commented to avoid bad looking logs
