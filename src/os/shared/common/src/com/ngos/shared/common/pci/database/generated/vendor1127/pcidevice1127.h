...
enum class PciDevice1127: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0200 = 0x0200,
    DEVICE_0210 = 0x0210,
...
inline const char8* enumToHumanString(PciDevice1127 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
