#ifndef OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_DMI_DMIIDENTITY_H
#define OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_DMI_DMIIDENTITY_H
...
#endif // OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_DMI_DMIIDENTITY_H
