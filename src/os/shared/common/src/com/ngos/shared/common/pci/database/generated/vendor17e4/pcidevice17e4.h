...
enum class PciDevice17E4: u16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0001 = 0x0001,
    DEVICE_0002 = 0x0002
...
inline const char8* enumToString(PciDevice17E4 device17E4) // TEST: NO
{
    // COMMON_LT((" | device17E4 = %u", device17E4)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice17E4 device17E4) // TEST: NO
{
    // COMMON_LT((" | device17E4 = %u", device17E4)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device17E4, enumToString(device17E4));
...
inline const char8* enumToHumanString(PciDevice17E4 device17E4) // TEST: NO
{
    // COMMON_LT((" | device17E4 = %u", device17E4)); // Commented to avoid bad looking logs
