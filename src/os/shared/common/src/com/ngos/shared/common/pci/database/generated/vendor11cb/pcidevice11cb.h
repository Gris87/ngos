...
enum class PciDevice11CB: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_2000 = 0x2000,
    DEVICE_4000 = 0x4000,
...
inline const char8* enumToHumanString(PciDevice11CB device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
