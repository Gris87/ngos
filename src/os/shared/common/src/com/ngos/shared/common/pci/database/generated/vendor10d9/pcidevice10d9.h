...
enum class PciDevice10D9: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0431 = 0x0431,
    DEVICE_0512 = 0x0512,
...
inline const char8* enumToHumanString(PciDevice10D9 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
