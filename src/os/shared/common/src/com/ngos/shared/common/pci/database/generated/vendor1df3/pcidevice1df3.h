...
enum class PciDevice1DF3: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0201 = 0x0201,
    DEVICE_0202 = 0x0202,
...
inline const char8* enumToHumanString(PciDevice1DF3 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
