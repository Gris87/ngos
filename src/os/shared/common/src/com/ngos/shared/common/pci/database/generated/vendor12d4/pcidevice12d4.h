...
inline const char8* enumToString(PciDevice12D4 device12D4) // TEST: NO
{
    // COMMON_LT((" | device12D4 = %u", device12D4)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice12D4 device12D4) // TEST: NO
{
    // COMMON_LT((" | device12D4 = %u", device12D4)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device12D4, enumToString(device12D4));
...
inline const char8* enumToHumanString(PciDevice12D4 device12D4) // TEST: NO
{
    // COMMON_LT((" | device12D4 = %u", device12D4)); // Commented to avoid bad looking logs
