...
enum class PciDevice15C7: u16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0349 = 0x0349
};
...
inline const char8* enumToString(PciDevice15C7 device15C7) // TEST: NO
{
    // COMMON_LT((" | device15C7 = %u", device15C7)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice15C7 device15C7) // TEST: NO
{
    // COMMON_LT((" | device15C7 = %u", device15C7)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device15C7, enumToString(device15C7));
...
inline const char8* enumToHumanString(PciDevice15C7 device15C7) // TEST: NO
{
    // COMMON_LT((" | device15C7 = %u", device15C7)); // Commented to avoid bad looking logs
