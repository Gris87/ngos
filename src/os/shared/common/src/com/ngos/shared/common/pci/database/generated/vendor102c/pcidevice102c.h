...
enum class PciDevice102C: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_00B8 = 0x00B8,
    DEVICE_00C0 = 0x00C0,
...
inline const char8* enumToHumanString(PciDevice102C device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
