...
inline const char8* enumToString(PciDevice1E89 device1E89) // TEST: NO
{
    // COMMON_LT((" | device1E89 = %u", device1E89)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1E89 device1E89) // TEST: NO
{
    // COMMON_LT((" | device1E89 = %u", device1E89)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1E89, enumToString(device1E89));
...
inline const char8* enumToHumanString(PciDevice1E89 device1E89) // TEST: NO
{
    // COMMON_LT((" | device1E89 = %u", device1E89)); // Commented to avoid bad looking logs
