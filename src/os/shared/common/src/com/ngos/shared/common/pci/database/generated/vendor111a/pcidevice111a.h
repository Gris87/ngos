...
enum class PciDevice111A: bad_uint16 // Ignore CppEnumVerifier
{
    DEVICE_0000 = 0x0000,
    DEVICE_0002 = 0x0002,
    DEVICE_0003 = 0x0003,
...
inline const char8* enumToHumanString(PciDevice111A device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
