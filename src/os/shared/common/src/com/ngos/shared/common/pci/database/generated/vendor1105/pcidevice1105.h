...
enum class PciDevice1105: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1105 = 0x1105,
    DEVICE_8300 = 0x8300,
...
inline const char8* enumToHumanString(PciDevice1105 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
