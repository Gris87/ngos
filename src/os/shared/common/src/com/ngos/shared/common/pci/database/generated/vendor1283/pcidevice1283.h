...
inline const char8* enumToHumanString(PciDevice1283 device, u16 subsystemVendorID, u16 subDeviceId) // TEST: NO
{
    ...
    switch (device)
    {
        ...
        case PciDevice1283::DEVICE_8892: return "Unknown device";
