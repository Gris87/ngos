#ifndef COM_NGOS_SHARED_COMMON_UEFI_UEFIPCIROOTBRIDGEIOPROTOCOLWIDTH_H
#define COM_NGOS_SHARED_COMMON_UEFI_UEFIPCIROOTBRIDGEIOPROTOCOLWIDTH_H
...
enum class UefiPciRootBridgeIoProtocolWidth: bad_uint32
{
    UINT8,
    UINT16,
    UINT32,
...
inline const char8* enumToFullString(UefiPciRootBridgeIoProtocolWidth width) // TEST: NO
{
    ...
    sprintf(res, "0x%08X (%s)", (bad_uint32)width, enumToString(width));
...
#endif // COM_NGOS_SHARED_COMMON_UEFI_UEFIPCIROOTBRIDGEIOPROTOCOLWIDTH_H
