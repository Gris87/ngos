...
enum class PciDevice1013: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0038 = 0x0038,
    DEVICE_0040 = 0x0040,
...
inline const char8* enumToHumanString(PciDevice1013 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
