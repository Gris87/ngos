...
enum class PciDevice10B7: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0001 = 0x0001,
    DEVICE_0013 = 0x0013,
...
inline const char8* enumToHumanString(PciDevice10B7 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
