#ifndef COM_NGOS_SHARED_COMMON_GRAPHICS_PNG_LIB_PNGCOLORTYPE_H
#define COM_NGOS_SHARED_COMMON_GRAPHICS_PNG_LIB_PNGCOLORTYPE_H
...
#endif // COM_NGOS_SHARED_COMMON_GRAPHICS_PNG_LIB_PNGCOLORTYPE_H
