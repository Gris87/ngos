...
enum class PciSubDevice80861903: u32 // Ignore CppEnumVerifier
{
    NONE               = 0,
...
inline const char8* enumToString(PciSubDevice80861903 subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice80861903::SUBDEVICE_102809BE: return "SUBDEVICE_102809BE";
...
inline const char8* enumToHumanString(PciSubDevice80861903 subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice80861903::SUBDEVICE_102809BE: return "Latitude 7410";
