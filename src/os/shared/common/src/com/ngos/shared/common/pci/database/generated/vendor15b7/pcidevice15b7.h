...
enum class PciDevice15B7: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_2001 = 0x2001,
    DEVICE_5001 = 0x5001,
...
inline const char8* enumToHumanString(PciDevice15B7 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
