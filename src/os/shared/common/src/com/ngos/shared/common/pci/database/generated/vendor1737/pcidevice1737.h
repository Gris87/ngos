...
enum class PciDevice1737: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0029 = 0x0029,
    DEVICE_1032 = 0x1032,
...
inline const char8* enumToHumanString(PciDevice1737 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
