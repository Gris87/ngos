...
enum class PciDevice544D: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_6178 = 0x6178
};
...
inline const char8* enumToHumanString(PciDevice544D device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
