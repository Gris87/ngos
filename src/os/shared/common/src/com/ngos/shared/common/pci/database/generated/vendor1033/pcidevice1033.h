...
enum class PciDevice1033: bad_uint16 // Ignore CppEnumVerifier
{
    DEVICE_0000 = 0x0000,
    DEVICE_0001 = 0x0001,
    DEVICE_0002 = 0x0002,
...
inline const char8* enumToHumanString(PciDevice1033 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
