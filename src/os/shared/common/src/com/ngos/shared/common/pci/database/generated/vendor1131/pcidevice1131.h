...
enum class PciDevice1131: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1561 = 0x1561,
    DEVICE_1562 = 0x1562,
...
inline const char8* enumToHumanString(PciDevice1131 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
