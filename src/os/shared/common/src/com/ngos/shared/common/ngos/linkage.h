#ifndef OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_NGOS_LINKAGE_H
#define OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_NGOS_LINKAGE_H
...
#endif // OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_NGOS_LINKAGE_H
