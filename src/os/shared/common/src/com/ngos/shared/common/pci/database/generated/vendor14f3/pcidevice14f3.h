...
inline const char8* enumToString(PciDevice14F3 device14F3) // TEST: NO
{
    // COMMON_LT((" | device14F3 = %u", device14F3)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice14F3 device14F3) // TEST: NO
{
    // COMMON_LT((" | device14F3 = %u", device14F3)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device14F3, enumToString(device14F3));
...
inline const char8* enumToHumanString(PciDevice14F3 device14F3) // TEST: NO
{
    // COMMON_LT((" | device14F3 = %u", device14F3)); // Commented to avoid bad looking logs
