...
enum class PciDevice1E3B: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1098 = 0x1098
};
...
inline const char8* enumToHumanString(PciDevice1E3B device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
