...
inline const char8* enumToString(PciDevice1402 device1402) // TEST: NO
{
    // COMMON_LT((" | device1402 = %u", device1402)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1402 device1402) // TEST: NO
{
    // COMMON_LT((" | device1402 = %u", device1402)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1402, enumToString(device1402));
...
inline const char8* enumToHumanString(PciDevice1402 device1402) // TEST: NO
{
    // COMMON_LT((" | device1402 = %u", device1402)); // Commented to avoid bad looking logs
