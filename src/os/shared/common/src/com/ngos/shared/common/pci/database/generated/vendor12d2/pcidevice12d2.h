...
enum class PciDevice12D2: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0008 = 0x0008,
    DEVICE_0009 = 0x0009,
...
inline const char8* enumToHumanString(PciDevice12D2 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
