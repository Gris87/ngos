...
enum class PciDevice10E3: bad_uint16 // Ignore CppEnumVerifier
{
    DEVICE_0000 = 0x0000,
    DEVICE_0108 = 0x0108,
    DEVICE_0148 = 0x0148,
...
inline const char8* enumToHumanString(PciDevice10E3 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
