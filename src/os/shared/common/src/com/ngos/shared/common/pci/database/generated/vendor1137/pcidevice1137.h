...
enum class PciDevice1137: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0023 = 0x0023,
    DEVICE_0040 = 0x0040,
...
inline const char8* enumToHumanString(PciDevice1137 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
