#ifndef COM_NGOS_SHARED_COMMON_CPU_MSR_MSRREGISTERS_H
#define COM_NGOS_SHARED_COMMON_CPU_MSR_MSRREGISTERS_H
...
#endif // COM_NGOS_SHARED_COMMON_CPU_MSR_MSRREGISTERS_H
