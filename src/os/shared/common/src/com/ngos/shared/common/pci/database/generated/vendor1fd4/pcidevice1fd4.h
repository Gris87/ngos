...
inline const char8* enumToString(PciDevice1FD4 device1FD4) // TEST: NO
{
    // COMMON_LT((" | device1FD4 = %u", device1FD4)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1FD4 device1FD4) // TEST: NO
{
    // COMMON_LT((" | device1FD4 = %u", device1FD4)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1FD4, enumToString(device1FD4));
...
inline const char8* enumToHumanString(PciDevice1FD4 device1FD4) // TEST: NO
{
    // COMMON_LT((" | device1FD4 = %u", device1FD4)); // Commented to avoid bad looking logs
