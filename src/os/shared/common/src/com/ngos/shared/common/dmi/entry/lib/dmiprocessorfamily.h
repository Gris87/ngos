#ifndef COM_NGOS_SHARED_COMMON_DMI_ENTRY_LIB_DMIPROCESSORFAMILY_H
#define COM_NGOS_SHARED_COMMON_DMI_ENTRY_LIB_DMIPROCESSORFAMILY_H
...
enum class DmiProcessorFamily: bad_uint8
{
    NONE                                   = 0,
    OTHER                                  = 0x01,
    UNKNOWN                                = 0x02,
...
inline const char8* enumToString(DmiProcessorFamily family) // TEST: NO
{
    ...
    switch (family)
    {
        ...
        case DmiProcessorFamily::_8086:                                  return "8086";
        case DmiProcessorFamily::_80286:                                 return "80286";
        case DmiProcessorFamily::INTEL_386:                              return "INTEL_386";
        case DmiProcessorFamily::INTEL_486:                              return "INTEL_486";
        case DmiProcessorFamily::_8087:                                  return "8087";
        case DmiProcessorFamily::_80287:                                 return "80287";
        case DmiProcessorFamily::_80387:                                 return "80387";
        case DmiProcessorFamily::_80487:                                 return "80487";
        ...
        case DmiProcessorFamily::_68040:                                 return "68040";
        case DmiProcessorFamily::_68XXX:                                 return "68XXX";
        case DmiProcessorFamily::_68000:                                 return "68000";
        case DmiProcessorFamily::_68010:                                 return "68010";
        case DmiProcessorFamily::_68020:                                 return "68020";
        case DmiProcessorFamily::_68030:                                 return "68030";
        ...
        case DmiProcessorFamily::bad_int860:                                   return "bad_int860";
...
inline const char8* enumToFullString(DmiProcessorFamily family) // TEST: NO
{
    ...
    sprintf(res, "0x%02X (%s)", (bad_uint8)family, enumToString(family));
...
#endif // COM_NGOS_SHARED_COMMON_DMI_ENTRY_LIB_DMIPROCESSORFAMILY_H
