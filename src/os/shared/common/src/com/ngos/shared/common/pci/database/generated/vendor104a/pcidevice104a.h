...
inline const char8* enumToString(PciDevice104A device104A) // TEST: NO
{
    // COMMON_LT((" | device104A = %u", device104A)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice104A device104A) // TEST: NO
{
    // COMMON_LT((" | device104A = %u", device104A)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device104A, enumToString(device104A));
...
inline const char8* enumToHumanString(PciDevice104A device104A) // TEST: NO
{
    // COMMON_LT((" | device104A = %u", device104A)); // Commented to avoid bad looking logs
