...
enum class PciDevice104A: bad_uint16 // Ignore CppEnumVerifier
{
    DEVICE_0000 = 0x0000,
    DEVICE_0008 = 0x0008,
    DEVICE_0009 = 0x0009,
...
inline const char8* enumToHumanString(PciDevice104A device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
