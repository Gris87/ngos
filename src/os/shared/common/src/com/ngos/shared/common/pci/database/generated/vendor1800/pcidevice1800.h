...
inline const char8* enumToString(PciDevice1800 device1800) // TEST: NO
{
    // COMMON_LT((" | device1800 = %u", device1800)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1800 device1800) // TEST: NO
{
    // COMMON_LT((" | device1800 = %u", device1800)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1800, enumToString(device1800));
...
inline const char8* enumToHumanString(PciDevice1800 device1800) // TEST: NO
{
    // COMMON_LT((" | device1800 = %u", device1800)); // Commented to avoid bad looking logs
