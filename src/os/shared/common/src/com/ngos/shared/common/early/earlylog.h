#ifndef OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_EARLY_EARLYLOG_H
#define OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_EARLY_EARLYLOG_H
...
#endif // OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_EARLY_EARLYLOG_H
