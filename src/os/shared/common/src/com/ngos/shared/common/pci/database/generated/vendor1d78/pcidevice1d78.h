...
enum class PciDevice1D78: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1512 = 0x1512
};
...
inline const char8* enumToHumanString(PciDevice1D78 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
