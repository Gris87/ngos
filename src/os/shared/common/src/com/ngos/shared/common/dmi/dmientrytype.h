#ifndef COM_NGOS_SHARED_COMMON_DMI_DMIENTRYTYPE_H
#define COM_NGOS_SHARED_COMMON_DMI_DMIENTRYTYPE_H
...
enum class DmiEntryType: bad_uint8
{
    BIOS                                 = 0,
    SYSTEM                               = 1,
    BASEBOARD                            = 2,
...
#endif // COM_NGOS_SHARED_COMMON_DMI_DMIENTRYTYPE_H
