#ifndef COM_NGOS_SHARED_COMMON_CONTAINERS_LIB_LISTELEMENT_H
#define COM_NGOS_SHARED_COMMON_CONTAINERS_LIB_LISTELEMENT_H
...
#endif // COM_NGOS_SHARED_COMMON_CONTAINERS_LIB_LISTELEMENT_H
