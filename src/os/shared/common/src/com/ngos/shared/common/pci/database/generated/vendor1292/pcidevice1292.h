...
inline const char8* enumToString(PciDevice1292 device1292) // TEST: NO
{
    // COMMON_LT((" | device1292 = %u", device1292)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1292 device1292) // TEST: NO
{
    // COMMON_LT((" | device1292 = %u", device1292)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1292, enumToString(device1292));
...
inline const char8* enumToHumanString(PciDevice1292 device1292) // TEST: NO
{
    // COMMON_LT((" | device1292 = %u", device1292)); // Commented to avoid bad looking logs
