...
enum class PciDevice1966: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1975 = 0x1975,
    DEVICE_1977 = 0x1977,
...
inline const char8* enumToHumanString(PciDevice1966 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
