...
enum class PciDevice1ADE: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1501 = 0x1501,
    DEVICE_3038 = 0x3038
...
inline const char8* enumToHumanString(PciDevice1ADE device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
