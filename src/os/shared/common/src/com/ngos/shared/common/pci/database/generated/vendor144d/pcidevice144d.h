...
enum class PciDevice144D: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1600 = 0x1600,
    DEVICE_A544 = 0xA544,
...
inline const char8* enumToHumanString(PciDevice144D device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
