#ifndef COM_NGOS_SHARED_COMMON_UEFI_UEFIACPIDESCRIPTOR_H
#define COM_NGOS_SHARED_COMMON_UEFI_UEFIACPIDESCRIPTOR_H
...
#endif // COM_NGOS_SHARED_COMMON_UEFI_UEFIACPIDESCRIPTOR_H
