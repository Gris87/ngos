#ifndef OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_DMI_DMISTOREDUUID_H
#define OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_DMI_DMISTOREDUUID_H
...
#endif // OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_DMI_DMISTOREDUUID_H
