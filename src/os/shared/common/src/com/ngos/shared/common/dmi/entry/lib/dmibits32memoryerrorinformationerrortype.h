#ifndef COM_NGOS_SHARED_COMMON_DMI_ENTRY_LIB_DMIBITS32MEMORYERRORINFORMATIONERRORTYPE_H
#define COM_NGOS_SHARED_COMMON_DMI_ENTRY_LIB_DMIBITS32MEMORYERRORINFORMATIONERRORTYPE_H
...
enum class DmiBits32MemoryErrorInformationErrorType: bad_uint8
{
    NONE                        = 0,
    OTHER                       = 1,
    UNKNOWN                     = 2,
...
#endif // COM_NGOS_SHARED_COMMON_DMI_ENTRY_LIB_DMIBITS32MEMORYERRORINFORMATIONERRORTYPE_H
