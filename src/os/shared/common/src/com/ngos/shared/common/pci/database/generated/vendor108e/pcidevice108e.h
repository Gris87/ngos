...
enum class PciDevice108E: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0001 = 0x0001,
    DEVICE_1000 = 0x1000,
...
inline const char8* enumToHumanString(PciDevice108E device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
