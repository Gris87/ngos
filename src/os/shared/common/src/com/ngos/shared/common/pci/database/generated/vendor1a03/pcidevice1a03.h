...
enum class PciDevice1A03: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1150 = 0x1150,
    DEVICE_2000 = 0x2000
...
inline const char8* enumToHumanString(PciDevice1A03 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
