...
enum class PciDevice15AD: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0405 = 0x0405,
    DEVICE_0710 = 0x0710,
...
inline const char8* enumToHumanString(PciDevice15AD device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
