...
enum class PciDevice127A: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1002 = 0x1002,
    DEVICE_1003 = 0x1003,
...
inline const char8* enumToHumanString(PciDevice127A device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
