...
enum class PciDevice9710: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_9250 = 0x9250,
    DEVICE_9805 = 0x9805,
...
inline const char8* enumToHumanString(PciDevice9710 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
