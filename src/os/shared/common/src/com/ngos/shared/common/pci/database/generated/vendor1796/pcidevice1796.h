...
inline const char8* enumToString(PciDevice1796 device1796) // TEST: NO
{
    // COMMON_LT((" | device1796 = %u", device1796)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1796 device1796) // TEST: NO
{
    // COMMON_LT((" | device1796 = %u", device1796)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1796, enumToString(device1796));
...
inline const char8* enumToHumanString(PciDevice1796 device1796) // TEST: NO
{
    // COMMON_LT((" | device1796 = %u", device1796)); // Commented to avoid bad looking logs
