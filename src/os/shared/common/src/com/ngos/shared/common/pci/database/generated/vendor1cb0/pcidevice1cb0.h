...
enum class PciDevice1CB0: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_D000 = 0xD000
};
...
inline const char8* enumToHumanString(PciDevice1CB0 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
