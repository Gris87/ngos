...
struct UefiBootServices
{
    ...
    UefiStatus (UEFI_API *allocatePages)(UefiAllocateType type, UefiMemoryType memoryType, u64 noPages, address_t *memory); // TEST: NO
    UefiStatus (UEFI_API *freePages)(address_t memory, u64 noPages); // TEST: NO
