...
enum class PciDevice1B73: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1000 = 0x1000,
    DEVICE_1009 = 0x1009,
...
inline const char8* enumToHumanString(PciDevice1B73 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
