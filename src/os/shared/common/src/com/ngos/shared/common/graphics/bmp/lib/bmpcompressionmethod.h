#ifndef COM_NGOS_SHARED_COMMON_GRAPHICS_BMP_LIB_BMPCOMPRESSIONMETHOD_H
#define COM_NGOS_SHARED_COMMON_GRAPHICS_BMP_LIB_BMPCOMPRESSIONMETHOD_H
...
#endif // COM_NGOS_SHARED_COMMON_GRAPHICS_BMP_LIB_BMPCOMPRESSIONMETHOD_H
