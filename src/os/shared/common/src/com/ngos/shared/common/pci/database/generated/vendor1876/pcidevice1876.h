...
inline const char8* enumToString(PciDevice1876 device1876) // TEST: NO
{
    // COMMON_LT((" | device1876 = %u", device1876)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1876 device1876) // TEST: NO
{
    // COMMON_LT((" | device1876 = %u", device1876)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1876, enumToString(device1876));
...
inline const char8* enumToHumanString(PciDevice1876 device1876) // TEST: NO
{
    // COMMON_LT((" | device1876 = %u", device1876)); // Commented to avoid bad looking logs
