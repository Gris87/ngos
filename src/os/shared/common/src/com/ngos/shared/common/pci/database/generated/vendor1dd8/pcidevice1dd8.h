...
enum class PciDevice1DD8: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1000 = 0x1000,
    DEVICE_1001 = 0x1001,
...
inline const char8* enumToHumanString(PciDevice1DD8 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
