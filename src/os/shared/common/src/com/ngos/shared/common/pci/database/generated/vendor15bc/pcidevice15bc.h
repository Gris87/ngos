...
enum class PciDevice15BC: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0100 = 0x0100,
    DEVICE_0103 = 0x0103,
...
inline const char8* enumToHumanString(PciDevice15BC device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
