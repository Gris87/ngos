...
inline const char8* enumToString(PciDevice1BD0 device1BD0) // TEST: NO
{
    // COMMON_LT((" | device1BD0 = %u", device1BD0)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1BD0 device1BD0) // TEST: NO
{
    // COMMON_LT((" | device1BD0 = %u", device1BD0)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1BD0, enumToString(device1BD0));
...
inline const char8* enumToHumanString(PciDevice1BD0 device1BD0) // TEST: NO
{
    // COMMON_LT((" | device1BD0 = %u", device1BD0)); // Commented to avoid bad looking logs
