...
enum class PciDevice4444: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0016 = 0x0016,
    DEVICE_0803 = 0x0803
...
inline const char8* enumToHumanString(PciDevice4444 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
