...
enum class PciDevice1023: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0194 = 0x0194,
    DEVICE_2000 = 0x2000,
...
inline const char8* enumToHumanString(PciDevice1023 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
