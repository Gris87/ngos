#ifndef COM_NGOS_SHARED_COMMON_GUI_WIDGETS_CONTROLS_TABBUTTON_H
#define COM_NGOS_SHARED_COMMON_GUI_WIDGETS_CONTROLS_TABBUTTON_H
...
#endif // COM_NGOS_SHARED_COMMON_GUI_WIDGETS_CONTROLS_TABBUTTON_H
