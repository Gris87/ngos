...
inline const char8* enumToString(PciDevice1120 device1120) // TEST: NO
{
    // COMMON_LT((" | device1120 = %u", device1120)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1120 device1120) // TEST: NO
{
    // COMMON_LT((" | device1120 = %u", device1120)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1120, enumToString(device1120));
...
inline const char8* enumToHumanString(PciDevice1120 device1120) // TEST: NO
{
    // COMMON_LT((" | device1120 = %u", device1120)); // Commented to avoid bad looking logs
