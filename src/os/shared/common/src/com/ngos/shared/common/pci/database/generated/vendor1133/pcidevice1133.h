...
enum class PciDevice1133: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_7701 = 0x7701,
    DEVICE_7711 = 0x7711,
...
inline const char8* enumToHumanString(PciDevice1133 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
