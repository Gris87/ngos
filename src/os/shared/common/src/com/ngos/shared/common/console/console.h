#ifndef OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_CONSOLE_CONSOLE_H
#define OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_CONSOLE_CONSOLE_H
...
#endif // OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_CONSOLE_CONSOLE_H
