...
inline const char8* enumToString(PciSubDevice1B4B9230 subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice1B4B9230::SUBDEVICE_1BD40073: return "SUBDEVICE_1BD40073";
...
inline const char8* enumToHumanString(PciSubDevice1B4B9230 subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice1B4B9230::SUBDEVICE_1BD40073: return "RS0200L6R2iM2";
