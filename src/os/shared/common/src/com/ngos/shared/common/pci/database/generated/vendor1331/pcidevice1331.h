...
inline const char8* enumToString(PciDevice1331 device1331) // TEST: NO
{
    // COMMON_LT((" | device1331 = %u", device1331)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1331 device1331) // TEST: NO
{
    // COMMON_LT((" | device1331 = %u", device1331)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1331, enumToString(device1331));
...
inline const char8* enumToHumanString(PciDevice1331 device1331) // TEST: NO
{
    // COMMON_LT((" | device1331 = %u", device1331)); // Commented to avoid bad looking logs
