...
enum class PciDevice1148: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_4000 = 0x4000,
    DEVICE_4200 = 0x4200,
...
inline const char8* enumToHumanString(PciDevice1148 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
