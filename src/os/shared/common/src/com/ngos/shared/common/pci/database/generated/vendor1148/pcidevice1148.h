...
inline const char8* enumToString(PciDevice1148 device1148) // TEST: NO
{
    // COMMON_LT((" | device1148 = %u", device1148)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1148 device1148) // TEST: NO
{
    // COMMON_LT((" | device1148 = %u", device1148)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1148, enumToString(device1148));
...
inline const char8* enumToHumanString(PciDevice1148 device1148) // TEST: NO
{
    // COMMON_LT((" | device1148 = %u", device1148)); // Commented to avoid bad looking logs
