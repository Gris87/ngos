...
inline const char8* enumToString(PciDevice1571 device1571) // TEST: NO
{
    // COMMON_LT((" | device1571 = %u", device1571)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1571 device1571) // TEST: NO
{
    // COMMON_LT((" | device1571 = %u", device1571)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1571, enumToString(device1571));
...
inline const char8* enumToHumanString(PciDevice1571 device1571) // TEST: NO
{
    // COMMON_LT((" | device1571 = %u", device1571)); // Commented to avoid bad looking logs
