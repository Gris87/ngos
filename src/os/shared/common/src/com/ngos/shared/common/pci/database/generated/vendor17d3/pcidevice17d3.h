...
enum class PciDevice17D3: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1110 = 0x1110,
    DEVICE_1120 = 0x1120,
...
inline const char8* enumToHumanString(PciDevice17D3 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
    ...
    switch (device)
    {
        ...
        case PciDevice17D3::DEVICE_188A: return "Unknown device";
