#ifndef OS_SHARED_COMMON_SRC_BITS64_CPU_X86FEATUREWORD_H
#define OS_SHARED_COMMON_SRC_BITS64_CPU_X86FEATUREWORD_H
...
#endif // OS_SHARED_COMMON_SRC_BITS64_CPU_X86FEATUREWORD_H
