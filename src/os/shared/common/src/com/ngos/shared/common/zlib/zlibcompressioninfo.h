#ifndef OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_ZLIB_ZLIBCOMPRESSIONINFO_H
#define OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_ZLIB_ZLIBCOMPRESSIONINFO_H
...
#endif // OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_ZLIB_ZLIBCOMPRESSIONINFO_H
