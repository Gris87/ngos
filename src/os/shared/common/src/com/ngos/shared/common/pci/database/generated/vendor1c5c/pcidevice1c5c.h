...
enum class PciDevice1C5C: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1283 = 0x1283,
    DEVICE_1284 = 0x1284,
...
inline const char8* enumToHumanString(PciDevice1C5C device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
