...
enum class PciDevice1813: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_4000 = 0x4000,
    DEVICE_4100 = 0x4100
...
inline const char8* enumToHumanString(PciDevice1813 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
