...
inline const char8* enumToString(PciDevice1108 device1108) // TEST: NO
{
    // COMMON_LT((" | device1108 = %u", device1108)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1108 device1108) // TEST: NO
{
    // COMMON_LT((" | device1108 = %u", device1108)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1108, enumToString(device1108));
...
inline const char8* enumToHumanString(PciDevice1108 device1108) // TEST: NO
{
    // COMMON_LT((" | device1108 = %u", device1108)); // Commented to avoid bad looking logs
