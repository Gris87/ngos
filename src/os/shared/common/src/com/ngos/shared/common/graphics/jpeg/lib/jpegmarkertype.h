#ifndef COM_NGOS_SHARED_COMMON_GRAPHICS_JPEG_LIB_JPEGMARKERTYPE_H
#define COM_NGOS_SHARED_COMMON_GRAPHICS_JPEG_LIB_JPEGMARKERTYPE_H
...
#endif // COM_NGOS_SHARED_COMMON_GRAPHICS_JPEG_LIB_JPEGMARKERTYPE_H
