...
enum class PciDevice1814: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0101 = 0x0101,
    DEVICE_0200 = 0x0200,
...
inline const char8* enumToHumanString(PciDevice1814 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
