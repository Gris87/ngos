...
enum class PciDevice13DF: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0001 = 0x0001
};
...
inline const char8* enumToHumanString(PciDevice13DF device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
