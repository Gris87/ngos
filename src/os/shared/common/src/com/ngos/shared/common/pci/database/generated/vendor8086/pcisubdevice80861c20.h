...
enum class PciSubDevice80861C20: bad_uint32 // Ignore CppEnumVerifier
{
    NONE               = 0,
...
inline const char8* enumToString(PciSubDevice80861C20 subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice80861C20::SUBDEVICE_8086200D: return "SUBDEVICE_8086200D";
...
inline const char8* enumToHumanString(PciSubDevice80861C20 subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice80861C20::SUBDEVICE_8086200D: return "DH61CR motherboard";
