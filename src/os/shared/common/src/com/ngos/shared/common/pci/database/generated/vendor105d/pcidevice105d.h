...
enum class PciDevice105D: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_2309 = 0x2309,
    DEVICE_2339 = 0x2339,
...
inline const char8* enumToHumanString(PciDevice105D device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
