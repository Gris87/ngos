...
enum class PciDevice1274: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1171 = 0x1171,
    DEVICE_1371 = 0x1371,
...
inline const char8* enumToHumanString(PciDevice1274 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
