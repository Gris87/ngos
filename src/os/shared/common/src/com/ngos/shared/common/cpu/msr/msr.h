#ifndef OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_CPU_MSR_MSR_H
#define OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_CPU_MSR_MSR_H
...
#endif // OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_CPU_MSR_MSR_H
