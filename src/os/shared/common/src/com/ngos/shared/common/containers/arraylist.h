#ifndef OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_CONTAINERS_ARRAYLIST_H
#define OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_CONTAINERS_ARRAYLIST_H
...
#endif // OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_CONTAINERS_ARRAYLIST_H
