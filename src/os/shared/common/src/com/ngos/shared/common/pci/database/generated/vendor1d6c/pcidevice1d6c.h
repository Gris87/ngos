...
enum class PciDevice1D6C: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1001 = 0x1001,
    DEVICE_1002 = 0x1002,
...
inline const char8* enumToHumanString(PciDevice1D6C device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
