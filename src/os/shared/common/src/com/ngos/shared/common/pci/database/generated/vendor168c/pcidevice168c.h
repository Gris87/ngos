...
enum class PciDevice168C: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0007 = 0x0007,
    DEVICE_0011 = 0x0011,
...
inline const char8* enumToHumanString(PciDevice168C device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
