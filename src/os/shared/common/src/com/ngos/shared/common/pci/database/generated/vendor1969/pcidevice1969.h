...
enum class PciDevice1969: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1026 = 0x1026,
    DEVICE_1048 = 0x1048,
...
inline const char8* enumToHumanString(PciDevice1969 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
