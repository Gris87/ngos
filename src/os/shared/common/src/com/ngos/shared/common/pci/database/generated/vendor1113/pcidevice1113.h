...
enum class PciDevice1113: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1211 = 0x1211,
    DEVICE_1216 = 0x1216,
...
inline const char8* enumToHumanString(PciDevice1113 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
