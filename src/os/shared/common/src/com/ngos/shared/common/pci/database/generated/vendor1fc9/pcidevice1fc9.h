...
enum class PciDevice1FC9: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_3009 = 0x3009,
    DEVICE_3010 = 0x3010,
...
inline const char8* enumToHumanString(PciDevice1FC9 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
