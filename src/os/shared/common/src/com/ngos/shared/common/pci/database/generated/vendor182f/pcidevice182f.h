...
inline const char8* enumToString(PciDevice182F device182F) // TEST: NO
{
    // COMMON_LT((" | device182F = %u", device182F)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice182F device182F) // TEST: NO
{
    // COMMON_LT((" | device182F = %u", device182F)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device182F, enumToString(device182F));
...
inline const char8* enumToHumanString(PciDevice182F device182F) // TEST: NO
{
    // COMMON_LT((" | device182F = %u", device182F)); // Commented to avoid bad looking logs
