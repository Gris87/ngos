...
enum class PciSubDevice80868C10: bad_uint32 // Ignore CppEnumVerifier
{
    NONE               = 0,
...
inline const char8* enumToString(PciSubDevice80868C10 subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice80868C10::SUBDEVICE_17AA3098: return "SUBDEVICE_17AA3098";
...
inline const char8* enumToHumanString(PciSubDevice80868C10 subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice80868C10::SUBDEVICE_17AA3098: return "ThinkCentre E73";
