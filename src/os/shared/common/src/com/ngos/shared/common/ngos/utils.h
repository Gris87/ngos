#ifndef OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_NGOS_UTILS_H
#define OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_NGOS_UTILS_H
...
#endif // OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_NGOS_UTILS_H
