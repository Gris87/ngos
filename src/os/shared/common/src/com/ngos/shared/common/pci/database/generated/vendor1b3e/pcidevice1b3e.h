...
enum class PciDevice1B3E: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1FA8 = 0x1FA8
};
...
inline const char8* enumToHumanString(PciDevice1B3E device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
