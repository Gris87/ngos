...
inline const char8* enumToString(PciDevice1425 device1425) // TEST: NO
{
    // COMMON_LT((" | device1425 = %u", device1425)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1425 device1425) // TEST: NO
{
    // COMMON_LT((" | device1425 = %u", device1425)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1425, enumToString(device1425));
...
inline const char8* enumToHumanString(PciDevice1425 device1425) // TEST: NO
{
    // COMMON_LT((" | device1425 = %u", device1425)); // Commented to avoid bad looking logs
