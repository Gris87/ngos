...
enum class PciDevice1425: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_000B = 0x000B,
    DEVICE_000C = 0x000C,
...
inline const char8* enumToHumanString(PciDevice1425 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
