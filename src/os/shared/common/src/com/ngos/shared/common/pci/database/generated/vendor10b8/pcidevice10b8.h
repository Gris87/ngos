...
enum class PciDevice10B8: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0005 = 0x0005,
    DEVICE_0006 = 0x0006,
...
inline const char8* enumToHumanString(PciDevice10B8 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
