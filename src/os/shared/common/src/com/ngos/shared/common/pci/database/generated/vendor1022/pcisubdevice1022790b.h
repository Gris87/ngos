...
inline const char8* enumToString(PciSubDevice1022790B subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice1022790B::SUBDEVICE_15D9790B: return "SUBDEVICE_15D9790B";
...
inline const char8* enumToHumanString(PciSubDevice1022790B subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice1022790B::SUBDEVICE_15D9790B: return "H12SSL-i";
