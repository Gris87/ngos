#ifndef COM_NGOS_SHARED_COMMON_ZLIB_ZLIBCOMPRESSIONLEVEL_H
#define COM_NGOS_SHARED_COMMON_ZLIB_ZLIBCOMPRESSIONLEVEL_H
...
#endif // COM_NGOS_SHARED_COMMON_ZLIB_ZLIBCOMPRESSIONLEVEL_H
