#ifndef OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_STRING_STRING_H
#define OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_STRING_STRING_H
...
#endif // OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_STRING_STRING_H
