...
inline const char8* enumToString(PciDevice11D4 device11D4) // TEST: NO
{
    // COMMON_LT((" | device11D4 = %u", device11D4)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice11D4 device11D4) // TEST: NO
{
    // COMMON_LT((" | device11D4 = %u", device11D4)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device11D4, enumToString(device11D4));
...
inline const char8* enumToHumanString(PciDevice11D4 device11D4) // TEST: NO
{
    // COMMON_LT((" | device11D4 = %u", device11D4)); // Commented to avoid bad looking logs
