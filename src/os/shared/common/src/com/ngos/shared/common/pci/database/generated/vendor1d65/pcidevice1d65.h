...
inline const char8* enumToString(PciDevice1D65 device1D65) // TEST: NO
{
    // COMMON_LT((" | device1D65 = %u", device1D65)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1D65 device1D65) // TEST: NO
{
    // COMMON_LT((" | device1D65 = %u", device1D65)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1D65, enumToString(device1D65));
...
inline const char8* enumToHumanString(PciDevice1D65 device1D65) // TEST: NO
{
    // COMMON_LT((" | device1D65 = %u", device1D65)); // Commented to avoid bad looking logs
