...
enum class PciDevice17D5: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_5731 = 0x5731,
    DEVICE_5732 = 0x5732,
...
inline const char8* enumToHumanString(PciDevice17D5 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
