#ifndef COM_NGOS_SHARED_COMMON_UEFI_UEFIPCIIOPROTOCOL_H
#define COM_NGOS_SHARED_COMMON_UEFI_UEFIPCIIOPROTOCOL_H
...
#endif // COM_NGOS_SHARED_COMMON_UEFI_UEFIPCIIOPROTOCOL_H
