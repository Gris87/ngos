#ifndef COM_NGOS_SHARED_COMMON_UEFI_UEFIDEVICEPATHTOTEXTPROTOCOL_H
#define COM_NGOS_SHARED_COMMON_UEFI_UEFIDEVICEPATHTOTEXTPROTOCOL_H
...
#endif // COM_NGOS_SHARED_COMMON_UEFI_UEFIDEVICEPATHTOTEXTPROTOCOL_H
