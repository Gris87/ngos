...
inline const char8* enumToString(PciDevice125C device125C) // TEST: NO
{
    // COMMON_LT((" | device125C = %u", device125C)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice125C device125C) // TEST: NO
{
    // COMMON_LT((" | device125C = %u", device125C)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device125C, enumToString(device125C));
...
inline const char8* enumToHumanString(PciDevice125C device125C) // TEST: NO
{
    // COMMON_LT((" | device125C = %u", device125C)); // Commented to avoid bad looking logs
