...
enum class PciDevice1B36: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0001 = 0x0001,
    DEVICE_0002 = 0x0002,
...
inline const char8* enumToHumanString(PciDevice1B36 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
