#ifndef COM_NGOS_SHARED_COMMON_DMI_ENTRY_LIB_DMIBASEBOARDTYPE_H
#define COM_NGOS_SHARED_COMMON_DMI_ENTRY_LIB_DMIBASEBOARDTYPE_H
...
enum class DmiBaseboardType: bad_uint8
{
    NONE                     = 0,
    UNKNOWN                  = 1,
    OTHER                    = 2,
...
#endif // COM_NGOS_SHARED_COMMON_DMI_ENTRY_LIB_DMIBASEBOARDTYPE_H
