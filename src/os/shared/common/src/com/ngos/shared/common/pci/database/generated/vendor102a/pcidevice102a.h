...
enum class PciDevice102A: bad_uint16 // Ignore CppEnumVerifier
{
    DEVICE_0000 = 0x0000,
    DEVICE_0010 = 0x0010,
    DEVICE_001F = 0x001F,
...
inline const char8* enumToHumanString(PciDevice102A device) // TEST: NO
{
    ...
    switch (device)
    {
        ...
        case PciDevice102A::DEVICE_00C5: return "AIC-7899 bad_uint160/m SCSI Controller";
        case PciDevice102A::DEVICE_00CF: return "AIC-7899P bad_uint160/m";
...
inline const char8* enumToHumanString(PciDevice102A device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
