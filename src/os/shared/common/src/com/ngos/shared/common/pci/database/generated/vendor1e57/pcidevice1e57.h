...
enum class PciDevice1E57: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0100 = 0x0100
};
...
inline const char8* enumToHumanString(PciDevice1E57 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
