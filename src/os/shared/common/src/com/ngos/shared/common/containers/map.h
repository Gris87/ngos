#ifndef COM_NGOS_SHARED_COMMON_CONTAINERS_MAP_H
#define COM_NGOS_SHARED_COMMON_CONTAINERS_MAP_H
...
template <typename Key, typename Value>
i64 Map<Key, Value>::getSize() const
{
...
#endif // COM_NGOS_SHARED_COMMON_CONTAINERS_MAP_H
