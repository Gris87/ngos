...
enum class PciDevice16D5: u16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0504 = 0x0504,
    DEVICE_0520 = 0x0520,
...
inline const char8* enumToString(PciDevice16D5 device16D5) // TEST: NO
{
    // COMMON_LT((" | device16D5 = %u", device16D5)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice16D5 device16D5) // TEST: NO
{
    // COMMON_LT((" | device16D5 = %u", device16D5)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device16D5, enumToString(device16D5));
...
inline const char8* enumToHumanString(PciDevice16D5 device16D5) // TEST: NO
{
    // COMMON_LT((" | device16D5 = %u", device16D5)); // Commented to avoid bad looking logs
