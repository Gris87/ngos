#ifndef OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_GDT_SEGMENTS_H
#define OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_GDT_SEGMENTS_H
...
#endif // OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_GDT_SEGMENTS_H
