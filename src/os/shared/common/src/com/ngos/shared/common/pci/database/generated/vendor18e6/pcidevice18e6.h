...
inline const char8* enumToString(PciDevice18E6 device18E6) // TEST: NO
{
    // COMMON_LT((" | device18E6 = %u", device18E6)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice18E6 device18E6) // TEST: NO
{
    // COMMON_LT((" | device18E6 = %u", device18E6)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device18E6, enumToString(device18E6));
...
inline const char8* enumToHumanString(PciDevice18E6 device18E6) // TEST: NO
{
    // COMMON_LT((" | device18E6 = %u", device18E6)); // Commented to avoid bad looking logs
