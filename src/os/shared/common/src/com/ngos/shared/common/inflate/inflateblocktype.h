#ifndef OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_INFLATE_INFLATEBLOCKTYPE_H
#define OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_INFLATE_INFLATEBLOCKTYPE_H
...
#endif // OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_INFLATE_INFLATEBLOCKTYPE_H
