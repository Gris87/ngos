...
inline const char8* enumToString(PciDevice1389 device1389) // TEST: NO
{
    // COMMON_LT((" | device1389 = %u", device1389)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1389 device1389) // TEST: NO
{
    // COMMON_LT((" | device1389 = %u", device1389)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1389, enumToString(device1389));
...
inline const char8* enumToHumanString(PciDevice1389 device1389) // TEST: NO
{
    // COMMON_LT((" | device1389 = %u", device1389)); // Commented to avoid bad looking logs
