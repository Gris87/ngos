...
enum class PciSubDevice80869D3A: bad_uint32 // Ignore CppEnumVerifier
{
    NONE               = 0,
...
inline const char8* enumToString(PciSubDevice80869D3A subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice80869D3A::SUBDEVICE_102806E6: return "SUBDEVICE_102806E6";
...
inline const char8* enumToHumanString(PciSubDevice80869D3A subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice80869D3A::SUBDEVICE_102806E6: return "Latitude 11 5175 2-in-1";
