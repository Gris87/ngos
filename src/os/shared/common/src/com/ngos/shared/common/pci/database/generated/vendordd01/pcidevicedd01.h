...
enum class PciDeviceDD01: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0003 = 0x0003,
    DEVICE_0006 = 0x0006,
...
inline const char8* enumToHumanString(PciDeviceDD01 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
