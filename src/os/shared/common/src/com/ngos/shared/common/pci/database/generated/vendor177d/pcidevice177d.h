...
enum class PciDevice177D: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0001 = 0x0001,
    DEVICE_0003 = 0x0003,
...
inline const char8* enumToHumanString(PciDevice177D device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
