...
enum class PciDevice1102: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0002 = 0x0002,
    DEVICE_0003 = 0x0003,
...
inline const char8* enumToHumanString(PciDevice1102 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
