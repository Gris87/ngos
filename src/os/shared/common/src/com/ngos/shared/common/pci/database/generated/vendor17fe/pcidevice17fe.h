...
enum class PciDevice17FE: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_2120 = 0x2120,
    DEVICE_2220 = 0x2220
...
inline const char8* enumToHumanString(PciDevice17FE device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
