...
inline const char8* enumToString(PciDevice1A30 device1A30) // TEST: NO
{
    // COMMON_LT((" | device1A30 = %u", device1A30)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1A30 device1A30) // TEST: NO
{
    // COMMON_LT((" | device1A30 = %u", device1A30)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1A30, enumToString(device1A30));
...
inline const char8* enumToHumanString(PciDevice1A30 device1A30) // TEST: NO
{
    // COMMON_LT((" | device1A30 = %u", device1A30)); // Commented to avoid bad looking logs
