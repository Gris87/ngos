...
enum class PciDevice1282: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_6585 = 0x6585,
    DEVICE_9009 = 0x9009,
...
inline const char8* enumToHumanString(PciDevice1282 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
