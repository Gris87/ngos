...
enum class PciSubDevice80862445: bad_uint32 // Ignore CppEnumVerifier
{
    NONE               = 0,
...
inline const char8* enumToString(PciSubDevice80862445 subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice80862445::SUBDEVICE_80864D44: return "SUBDEVICE_80864D44";
...
inline const char8* enumToHumanString(PciSubDevice80862445 subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice80862445::SUBDEVICE_80864D44: return "D850EMV2 motherboard";
