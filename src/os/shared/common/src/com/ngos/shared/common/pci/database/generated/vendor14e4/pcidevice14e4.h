...
enum class PciDevice14E4: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0576 = 0x0576,
    DEVICE_0800 = 0x0800,
...
inline const char8* enumToHumanString(PciDevice14E4 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
