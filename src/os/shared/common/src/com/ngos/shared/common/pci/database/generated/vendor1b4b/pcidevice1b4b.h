...
enum class PciDevice1B4B: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0640 = 0x0640,
    DEVICE_2241 = 0x2241,
...
inline const char8* enumToHumanString(PciDevice1B4B device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
