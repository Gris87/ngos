...
inline const char8* enumToString(PciSubDevice1002687F subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice1002687F::SUBDEVICE_104304C4: return "SUBDEVICE_104304C4";
...
inline const char8* enumToHumanString(PciSubDevice1002687F subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice1002687F::SUBDEVICE_104304C4: return "Radeon RX Vega 64";
