...
enum class PciDevice117C: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_002C = 0x002C,
    DEVICE_002D = 0x002D,
...
inline const char8* enumToHumanString(PciDevice117C device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
