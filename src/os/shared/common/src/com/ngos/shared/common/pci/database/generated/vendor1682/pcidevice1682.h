...
inline const char8* enumToString(PciDevice1682 device1682) // TEST: NO
{
    // COMMON_LT((" | device1682 = %u", device1682)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1682 device1682) // TEST: NO
{
    // COMMON_LT((" | device1682 = %u", device1682)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1682, enumToString(device1682));
...
inline const char8* enumToHumanString(PciDevice1682 device1682) // TEST: NO
{
    // COMMON_LT((" | device1682 = %u", device1682)); // Commented to avoid bad looking logs
