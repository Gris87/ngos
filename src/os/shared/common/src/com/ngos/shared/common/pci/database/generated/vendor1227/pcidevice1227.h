...
enum class PciDevice1227: u16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0006 = 0x0006,
    DEVICE_0023 = 0x0023,
...
inline const char8* enumToString(PciDevice1227 device1227) // TEST: NO
{
    // COMMON_LT((" | device1227 = %u", device1227)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1227 device1227) // TEST: NO
{
    // COMMON_LT((" | device1227 = %u", device1227)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1227, enumToString(device1227));
...
inline const char8* enumToHumanString(PciDevice1227 device1227) // TEST: NO
{
    // COMMON_LT((" | device1227 = %u", device1227)); // Commented to avoid bad looking logs
