...
enum class PciDevice103C: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1005 = 0x1005,
    DEVICE_1008 = 0x1008,
...
inline const char8* enumToHumanString(PciDevice103C device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
