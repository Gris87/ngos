#ifndef COM_NGOS_SHARED_COMMON_UEFI_UEFIINPUTKEYSCANCODE_H
#define COM_NGOS_SHARED_COMMON_UEFI_UEFIINPUTKEYSCANCODE_H
...
#endif // COM_NGOS_SHARED_COMMON_UEFI_UEFIINPUTKEYSCANCODE_H
