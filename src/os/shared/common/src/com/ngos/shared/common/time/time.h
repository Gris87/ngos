#ifndef OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_TIME_TIME_H
#define OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_TIME_TIME_H
...
#endif // OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_TIME_TIME_H
