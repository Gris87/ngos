...
enum class PciDevice1BB1: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_005D = 0x005D,
    DEVICE_0100 = 0x0100
...
inline const char8* enumToHumanString(PciDevice1BB1 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
