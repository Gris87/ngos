#ifndef OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_IDT_MACROS_H
#define OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_IDT_MACROS_H
...
#endif // OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_IDT_MACROS_H
