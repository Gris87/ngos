#ifndef COM_NGOS_SHARED_COMMON_GUI_OTHER_HORIZONTALALIGNMENT_H
#define COM_NGOS_SHARED_COMMON_GUI_OTHER_HORIZONTALALIGNMENT_H
...
#endif // COM_NGOS_SHARED_COMMON_GUI_OTHER_HORIZONTALALIGNMENT_H
