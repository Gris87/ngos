...
enum class PciSubDevice80861919: bad_uint32 // Ignore CppEnumVerifier
{
    NONE               = 0,
...
inline const char8* enumToString(PciSubDevice80861919 subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice80861919::SUBDEVICE_102806E6: return "SUBDEVICE_102806E6";
...
inline const char8* enumToHumanString(PciSubDevice80861919 subDevice) // TEST: NO
{
    ...
    switch (subDevice)
    {
        ...
        case PciSubDevice80861919::SUBDEVICE_102806E6: return "Latitude 11 5175 2-in-1";
