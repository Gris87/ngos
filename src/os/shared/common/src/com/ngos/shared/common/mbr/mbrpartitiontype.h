#ifndef COM_NGOS_SHARED_COMMON_MBR_MBRPARTITIONTYPE_H
#define COM_NGOS_SHARED_COMMON_MBR_MBRPARTITIONTYPE_H
...
#endif // COM_NGOS_SHARED_COMMON_MBR_MBRPARTITIONTYPE_H
