#ifndef OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_MBR_MBRPARTITIONTYPE_H
#define OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_MBR_MBRPARTITIONTYPE_H
...
inline const char8* enumToString(MbrPartitionType type) // TEST: NO
{
...
inline const char8* enumToFullString(MbrPartitionType type) // TEST: NO
{
    // COMMON_LT((" | type = %u", type)); // Commented to avoid bad looking logs
...
#endif // OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_MBR_MBRPARTITIONTYPE_H
