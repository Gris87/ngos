#ifndef OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_GUI_GUI_H
#define OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_GUI_GUI_H
...
#endif // OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_GUI_GUI_H
