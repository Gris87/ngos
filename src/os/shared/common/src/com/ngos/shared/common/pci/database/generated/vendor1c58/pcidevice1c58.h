...
enum class PciDevice1C58: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0003 = 0x0003,
    DEVICE_0023 = 0x0023
...
inline const char8* enumToHumanString(PciDevice1C58 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
