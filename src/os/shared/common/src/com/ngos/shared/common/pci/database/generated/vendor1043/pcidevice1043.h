...
enum class PciDevice1043: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_0464 = 0x0464,
    DEVICE_0521 = 0x0521,
...
inline const char8* enumToHumanString(PciDevice1043 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
