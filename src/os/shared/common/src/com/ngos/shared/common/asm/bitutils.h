#ifndef OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_ASM_BITUTILS_H
#define OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_ASM_BITUTILS_H
...
#endif // OS_SHARED_COMMON_SRC_COM_NGOS_SHARED_COMMON_ASM_BITUTILS_H
