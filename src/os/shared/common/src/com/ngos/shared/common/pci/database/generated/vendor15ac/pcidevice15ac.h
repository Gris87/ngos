...
inline const char8* enumToString(PciDevice15AC device15AC) // TEST: NO
{
    // COMMON_LT((" | device15AC = %u", device15AC)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice15AC device15AC) // TEST: NO
{
    // COMMON_LT((" | device15AC = %u", device15AC)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device15AC, enumToString(device15AC));
...
inline const char8* enumToHumanString(PciDevice15AC device15AC) // TEST: NO
{
    // COMMON_LT((" | device15AC = %u", device15AC)); // Commented to avoid bad looking logs
