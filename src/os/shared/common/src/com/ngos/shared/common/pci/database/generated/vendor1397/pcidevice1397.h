...
enum class PciDevice1397: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_08B4 = 0x08B4,
    DEVICE_16B8 = 0x16B8,
...
inline const char8* enumToHumanString(PciDevice1397 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
