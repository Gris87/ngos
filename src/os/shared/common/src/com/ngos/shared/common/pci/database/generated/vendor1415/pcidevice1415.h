...
enum class PciDevice1415: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_8401 = 0x8401,
    DEVICE_8403 = 0x8403,
...
inline const char8* enumToHumanString(PciDevice1415 device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
