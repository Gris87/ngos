...
enum class PciDevice122D: bad_uint16 // Ignore CppEnumVerifier
{
    NONE        = 0,
    DEVICE_1206 = 0x1206,
    DEVICE_1400 = 0x1400,
...
inline const char8* enumToHumanString(PciDevice122D device, bad_uint16 subsystemVendorID, bad_uint16 subDeviceId) // TEST: NO
{
