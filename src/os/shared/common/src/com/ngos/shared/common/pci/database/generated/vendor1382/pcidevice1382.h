...
inline const char8* enumToString(PciDevice1382 device1382) // TEST: NO
{
    // COMMON_LT((" | device1382 = %u", device1382)); // Commented to avoid bad looking logs
...
inline const char8* enumToFullString(PciDevice1382 device1382) // TEST: NO
{
    // COMMON_LT((" | device1382 = %u", device1382)); // Commented to avoid bad looking logs
    ...
    sprintf(res, "0x%04X (%s)", (u16)device1382, enumToString(device1382));
...
inline const char8* enumToHumanString(PciDevice1382 device1382) // TEST: NO
{
    // COMMON_LT((" | device1382 = %u", device1382)); // Commented to avoid bad looking logs
