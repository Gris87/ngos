...
#define HOVERED_COLOR          RGBA_FROM_HEX(0x909090DD)
#define PRESSED_COLOR          RGBA_FROM_HEX(0x606060DD)
#define FOCUSED_COLOR          RGBA_FROM_HEX(0x406090DD)
#define FOCUSED_HOVERED_COLOR  RGBA_FROM_HEX(0x304060DD)
#define INACTIVE_COLOR         RGBA_FROM_HEX(0xC0C0C0DD)
#define INACTIVE_HOVERED_COLOR RGBA_FROM_HEX(0xE0E0E0DD)
