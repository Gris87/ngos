#ifndef OS_SHARED_COMMON_SRC_BITS64_GUI_WIDGETS_SPECIAL_ROOTWIDGET_H
#define OS_SHARED_COMMON_SRC_BITS64_GUI_WIDGETS_SPECIAL_ROOTWIDGET_H
...
#endif // OS_SHARED_COMMON_SRC_BITS64_GUI_WIDGETS_SPECIAL_ROOTWIDGET_H
