#ifndef OS_SHARED_COMMON_SRC_BITS64_EARLY_EARLYLOG_H
#define OS_SHARED_COMMON_SRC_BITS64_EARLY_EARLYLOG_H
...
#endif // OS_SHARED_COMMON_SRC_BITS64_EARLY_EARLYLOG_H
