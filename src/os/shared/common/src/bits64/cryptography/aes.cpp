...
#define AES_KEY_EXPANSION_256(roundConstant, round) \
    ...
    "aeskeygenassist    $" #roundConstant ", %%xmm1, %%xmm2"                        "\n\t"    /* aeskeygenassist    $0x01, %xmm1, %xmm2     # Assist in AES round key generation using an 8 bits Round Constant */                                                                                                                                                                              \
                                                                                    "\n\t"                                                                                                                                                                                                                                                                                                      \
    "pshufd             $0xAA, %%xmm2, %%xmm2"                                      "\n\t"    /* pshufd             $0xAA, %xmm2, %xmm2     # Shuffle the doublewords in XMM2 based on the encoding in first argument and store the result in XMM2                                                              # XMM2[0] = XMM2[2], XMM2[1] = XMM2[2], XMM2[2] = XMM2[2], XMM2[3] = XMM2[2] */ \
    "shufps             $0x10, %%xmm4, %%xmm3"                                      "\n\t"    /* shufps             $0x10, %xmm4, %xmm3     # Select from quadruplet of single-precision floating-point values in XMM3 and XMM4 using encoding in first argument, interleaved result pairs are stored in XMM3   # XMM3[0] = XMM3[0], XMM3[1] = XMM3[0], XMM3[2] = XMM4[1], XMM3[3] = XMM4[0] */ \
    "pxor               %%xmm3, %%xmm4"                                             "\n\t"    /* pxor               %xmm3, %xmm4            # Perform bitwise XOR of XMM3 and XMM4 and store the result in XMM4 */                                                                                                                                                                              \
    "shufps             $0x8C, %%xmm4, %%xmm3"                                      "\n\t"    /* shufps             $0x8C, %xmm4, %xmm3     # Select from quadruplet of single-precision floating-point values in XMM3 and XMM4 using encoding in first argument, interleaved result pairs are stored in XMM3   # XMM3[0] = XMM3[0], XMM3[1] = XMM3[3], XMM3[2] = XMM4[0], XMM3[3] = XMM4[2] */ \
    "pxor               %%xmm3, %%xmm4"                                             "\n\t"    /* pxor               %xmm3, %xmm4            # Perform bitwise XOR of XMM3 and XMM4 and store the result in XMM4 */                                                                                                                                                                              \
    "pxor               %%xmm2, %%xmm4"                                             "\n\t"    /* pxor               %xmm2, %xmm4            # Perform bitwise XOR of XMM2 and XMM4 and store the result in XMM4 */                                                                                                                                                                              \
                                                                                    "\n\t"                                                                                                                                                                                                                                                                                                      \
