#ifndef OS_SHARED_COMMON_SRC_BITS64_GRAPHICS_JPEG_JPEGMARKERTYPE_H
#define OS_SHARED_COMMON_SRC_BITS64_GRAPHICS_JPEG_JPEGMARKERTYPE_H
...
#define JPEG_MARKER_SPLITTER          0xFF
...
inline const char* jpegMarkerTypeToString(JpegMarkerType type) // TEST: NO
{
    ...
    switch (type)
    {
        ...
        case JpegMarkerType::START_OF_FRAME_BASELINE_DCT:    return "START_OF_FRAME_BASELINE_DCT";
        case JpegMarkerType::START_OF_FRAME_PROGRESSIVE_DCT: return "START_OF_FRAME_PROGRESSIVE_DCT";
...
#endif // OS_SHARED_COMMON_SRC_BITS64_GRAPHICS_JPEG_JPEGMARKERTYPE_H
