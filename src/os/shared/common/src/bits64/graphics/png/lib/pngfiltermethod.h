#ifndef OS_SHARED_COMMON_SRC_BITS64_GRAPHICS_PNG_PNGFILTERMETHOD_H
#define OS_SHARED_COMMON_SRC_BITS64_GRAPHICS_PNG_PNGFILTERMETHOD_H
...
#endif // OS_SHARED_COMMON_SRC_BITS64_GRAPHICS_PNG_PNGFILTERMETHOD_H
