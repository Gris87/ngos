#ifndef OS_SHARED_COMMON_SRC_BITS64_FPU_XFEATURES_XFEATUREAVXSTATE_H
#define OS_SHARED_COMMON_SRC_BITS64_FPU_XFEATURES_XFEATUREAVXSTATE_H
...
#endif // OS_SHARED_COMMON_SRC_BITS64_FPU_XFEATURES_XFEATUREAVXSTATE_H
