...
NgosStatus setupInitTask()
{
    ...
    initTask.threadInfo.flags = FLAG(ThreadInfoFlag::NONE);
    ...
    // Validation
    {
        ...
        EARLY_LVVV(("initTask.threadInfo.flags == %u (%s)",   initTask.threadInfo.flags, threadInfoFlagsToString(initTask.threadInfo.flags)));
        ...
        EARLY_TEST_ASSERT(initTask.threadInfo.flags == FLAG(ThreadInfoFlag::NONE), NgosStatus::ASSERTION);
