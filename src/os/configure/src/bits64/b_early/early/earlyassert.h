#ifndef CONFIGURE_SRC_BITS64_B_EARLY_EARLY_EARLYASSERT_H
#define CONFIGURE_SRC_BITS64_B_EARLY_EARLY_EARLYASSERT_H
...
#define __EARLY_ASSERT_EXECUTION_1(command) \
    { \
        ...
        { \
            __EARLY_PRINT_ASSERT(("ASSERT:    %s:%u | Execution \"%s\" failed with error code 0x%016lX", __FILE__, __LINE__, #command, __exec_result)); \
            return; \
        } \
    }
...
#endif // CONFIGURE_SRC_BITS64_B_EARLY_EARLY_EARLYASSERT_H
