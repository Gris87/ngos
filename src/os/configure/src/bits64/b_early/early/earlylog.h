#ifndef CONFIGURE_SRC_BITS64_B_EARLY_EARLY_EARLYLOG_H
#define CONFIGURE_SRC_BITS64_B_EARLY_EARLY_EARLYLOG_H
...
#endif // CONFIGURE_SRC_BITS64_B_EARLY_EARLY_EARLYLOG_H
