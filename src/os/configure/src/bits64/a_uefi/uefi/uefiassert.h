#ifndef CONFIGURE_SRC_BITS64_A_UEFI_UEFI_UEFIASSERT_H
#define CONFIGURE_SRC_BITS64_A_UEFI_UEFI_UEFIASSERT_H
...
#endif // CONFIGURE_SRC_BITS64_A_UEFI_UEFI_UEFIASSERT_H
