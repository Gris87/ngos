#ifndef CONFIGURE_SRC_BITS64_OTHER_KERNELDESCRIPTOR_H
#define CONFIGURE_SRC_BITS64_OTHER_KERNELDESCRIPTOR_H
...
#endif // CONFIGURE_SRC_BITS64_OTHER_KERNELDESCRIPTOR_H
