#ifndef OS_COMMON_SRC_BITS64_MEMORYMANAGER_MEMORYBLOCKREGIONFLAGS_H
#define OS_COMMON_SRC_BITS64_MEMORYMANAGER_MEMORYBLOCKREGIONFLAGS_H
...
#endif // OS_COMMON_SRC_BITS64_MEMORYMANAGER_MEMORYBLOCKREGIONFLAGS_H
