#ifndef OS_KERNELBASE_SRC_BITS64_OTHER_MEMORYMANAGER_MEMORYMANAGER_H
#define OS_KERNELBASE_SRC_BITS64_OTHER_MEMORYMANAGER_MEMORYMANAGER_H
...
#endif // OS_KERNELBASE_SRC_BITS64_OTHER_MEMORYMANAGER_MEMORYMANAGER_H
