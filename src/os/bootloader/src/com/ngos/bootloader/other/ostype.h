#ifndef BOOTLOADER_SRC_COM_NGOS_BOOTLOADER_OTHER_OSTYPE_H
#define BOOTLOADER_SRC_COM_NGOS_BOOTLOADER_OTHER_OSTYPE_H
...
#endif // BOOTLOADER_SRC_COM_NGOS_BOOTLOADER_OTHER_OSTYPE_H
