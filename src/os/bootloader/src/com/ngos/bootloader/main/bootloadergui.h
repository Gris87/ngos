#ifndef COM_NGOS_BOOTLOADER_MAIN_BOOTLOADERGUI_H
#define COM_NGOS_BOOTLOADER_MAIN_BOOTLOADERGUI_H
...
private:
    ...
    static bad_uint64                  sOsButtonLeft;
    static bad_uint64                  sOsButtonRight;
    static bad_uint64                  sOsButtonSelected;
...
#endif // COM_NGOS_BOOTLOADER_MAIN_BOOTLOADERGUI_H
