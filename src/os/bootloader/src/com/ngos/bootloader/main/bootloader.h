#ifndef COM_NGOS_BOOTLOADER_MAIN_BOOTLOADER_H
#define COM_NGOS_BOOTLOADER_MAIN_BOOTLOADER_H
...
public:
    ...
    static NgosStatus startOs(i64 index); // TEST: NO
...
#endif // COM_NGOS_BOOTLOADER_MAIN_BOOTLOADER_H
