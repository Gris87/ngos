...
NgosStatus setupInitTask()
{
    ...
    // Validation
    {
        ...
        EARLY_LVVV(("*(bad_uint64 *)initTask.stack    == 0x%016llX", *(bad_uint64 *)initTask.stack));
        ...
        EARLY_TEST_ASSERT(*(bad_uint64 *)initTask.stack    == 0x444E454B43415453,          NgosStatus::ASSERTION);
    }
