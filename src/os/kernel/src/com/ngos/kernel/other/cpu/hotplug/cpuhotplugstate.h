#ifndef KERNEL_SRC_COM_NGOS_KERNEL_OTHER_CPU_HOTPLUG_CPUHOTPLUGSTATE_H
#define KERNEL_SRC_COM_NGOS_KERNEL_OTHER_CPU_HOTPLUG_CPUHOTPLUGSTATE_H
...
#endif // KERNEL_SRC_COM_NGOS_KERNEL_OTHER_CPU_HOTPLUG_CPUHOTPLUGSTATE_H
