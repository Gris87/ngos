#ifndef COM_NGOS_KERNEL_OTHER_TASK_THREADINFOFLAGS_H
#define COM_NGOS_KERNEL_OTHER_TASK_THREADINFOFLAGS_H
...
#endif // COM_NGOS_KERNEL_OTHER_TASK_THREADINFOFLAGS_H
