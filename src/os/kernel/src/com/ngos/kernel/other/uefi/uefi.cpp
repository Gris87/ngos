...
NgosStatus UEFI::initSystemTable()
{
    ...
    // Validation
    {
        ...
        COMMON_TEST_ASSERT(sSystemTable.firmwareVendor              != nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sSystemTable.firmwareRevision            == 0x00010000,                  NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sSystemTable.stdinHandle                 == nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sSystemTable.stdin                       == nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sSystemTable.stdoutHandle                == nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sSystemTable.stdout                      == nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sSystemTable.stderrHandle                == nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sSystemTable.stderr                      == nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sSystemTable.runtimeServices             != nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sSystemTable.bootServices                == nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sSystemTable.numberOfConfigurationTables == 10,                          NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sSystemTable.configurationTables         != nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sAcpi20Config                            != nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sAcpiConfig                              != nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sDebugInfoConfig                         != nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sDxeServicesConfig                       != nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sHcdpConfig                              == nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sHobListConfig                           != nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sLzmaDecompressConfig                    != nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sMemoryAttributesConfig                  != nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sMemoryStatusCodeRecordConfig            != nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sMemoryTypeInformationConfig             != nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sMpsConfig                               == nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sPropertiesConfig                        == nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sSalSystemConfig                         == nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sSmbios3Config                           == nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sSmbiosConfig                            != nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sSystemResourceConfig                    == nullptr,                     NgosStatus::ASSERTION);
        COMMON_TEST_ASSERT(sUgaIoConfig                             == nullptr,                     NgosStatus::ASSERTION);
    }
