#ifndef KERNEL_SRC_COM_NGOS_KERNEL_OTHER_HYPERVISOR_KVM_KVMFEATURE_H
#define KERNEL_SRC_COM_NGOS_KERNEL_OTHER_HYPERVISOR_KVM_KVMFEATURE_H
...
#endif // KERNEL_SRC_COM_NGOS_KERNEL_OTHER_HYPERVISOR_KVM_KVMFEATURE_H
