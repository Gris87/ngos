...
NgosStatus E820::init()
{
    ...
    // Validation
    {
        ...
        // COMMON_TEST_ASSERT(sTable.entries[0].start == 0x00000000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTable.entries[1].start == 0x00100000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTable.entries[2].start == 0x3EAD6000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTable.entries[3].start == 0x3EB1B000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTable.entries[4].start == 0x3FB9B000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTable.entries[5].start == 0x3FBF3000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTable.entries[6].start == 0x3FBFB000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTable.entries[7].start == 0x3FBFF000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTable.entries[8].start == 0x3FFE0000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTable.entries[9].start == 0xFFE00000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableKExec.entries[0].start == 0x00000000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableKExec.entries[1].start == 0x00100000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableKExec.entries[2].start == 0x3EAD6000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableKExec.entries[3].start == 0x3EB1B000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableKExec.entries[4].start == 0x3FB9B000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableKExec.entries[5].start == 0x3FBF3000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableKExec.entries[6].start == 0x3FBFB000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableKExec.entries[7].start == 0x3FBFF000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableKExec.entries[8].start == 0x3FFE0000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableKExec.entries[9].start == 0xFFE00000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableFirmware.entries[0].start == 0x00000000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableFirmware.entries[1].start == 0x00100000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableFirmware.entries[2].start == 0x3EAD6000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableFirmware.entries[3].start == 0x3EB1B000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableFirmware.entries[4].start == 0x3FB9B000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableFirmware.entries[5].start == 0x3FBF3000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableFirmware.entries[6].start == 0x3FBFB000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableFirmware.entries[7].start == 0x3FBFF000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableFirmware.entries[8].start == 0x3FFE0000,                   NgosStatus::ASSERTION); // Commented due to value variation
        ...
        // COMMON_TEST_ASSERT(sTableFirmware.entries[9].start == 0xFFE00000,                   NgosStatus::ASSERTION); // Commented due to value variation
