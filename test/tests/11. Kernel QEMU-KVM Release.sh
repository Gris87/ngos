...
KERNEL_LOG=../../tools/vm/qemu-kvm/logs/NGOS_dev.log                                                                                                                                                     # Colorize: green
...
tools/qt/build_config_maker/build/build_config_maker ${BUILD_CONFIG} --reset \
    ...
    NGOS_BUILD_X86_64_VECTORIZATION_MODE=OPTION_X86_64_VECTORIZATION_MODE_AVX2 \
    NGOS_BUILD_X86_64_FUSED_MULTIPLY_ADD=OPTION_X86_64_FUSED_MULTIPLY_ADD_FMA3 > ${BUILD_LOG} 2>&1 # Colorize: green
...
./start_vm.sh qemu-kvm none > ${VM_LOG} 2>&1 &                                                                                                                                                           # Colorize: green
cd ${CURRENT_PATH}/                                                                                                                                                                                       # Colorize: green
                                                                                                                                                                                                         # Colorize: green
                                                                                                                                                                                                         # Colorize: green
                                                                                                                                                                                                         # Colorize: green
